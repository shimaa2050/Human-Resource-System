...
/// </summary>
/// 
namespace shimaa11818WebApp.App_Code
{
   public class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["shimaa11818"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["shimaa11818"].ConnectionString);
        public CRUD()
        {
            //
        ...
        public object ExecuteScalar(string mySql, Dictionary<string, object> myPara)
        {
            object result = null;
        ...
        public int InsertUpdateDeleteViaSqlDic(string sql, Dictionary<string, object> parameters)
        {
            int rowsAffected = 0;
        ...
        public SqlDataReader getDrPassSqlDic(string sql, Dictionary<string, object> parameters)
        {
            ...
            // Important: Close connection automatically when reader closes
